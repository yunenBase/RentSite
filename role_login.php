...
<head>
  ...
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Anda Ingin Masuk Sebagai Apa?</title>
  </head>
...
<body>
  ...
  <div class="boxlogin">
    <form id="roleForm">
      <label for="role">Anda Ingin Masuk Sebagai Apa?</label>
  ...
  function redirectToForm() {
    ...
    switch (selectedRole) {
      ...
      case"penjaga":
            window.location.href = "log_penjaga.php";
      case "dosen":
        window.location.href = "log_dosen.php";
        break;
      case "mahasiswa":
        window.location.href = "log_mahasiswa.php";
        break;
    }
  }
  </script>
