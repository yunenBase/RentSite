...
if (!empty($idPeminjaman)) {
    ...
    $sqlUpdatePeminjaman = "UPDATE peminjaman_gedung SET status_upload_berkas = 1 WHERE id_peminjaman = $idPeminjaman";
...
<body>
    ...
    <div class="container">
        <div id="drop-area" class="row">
            <form id="upload-form" action="upload.php?id_peminjaman=<?php echo $idPeminjaman; ?>" method=" post"
                enctype="multipart/form-data">
                <input type="file" id="file-input" name="myfile" accept=".pdf" onchange="handleFileSelect(event)" />
                <input type="hidden" name="id_peminjaman" value="<?php echo $idPeminjaman; ?>">
