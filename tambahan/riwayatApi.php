...
if (!empty($idPeminjaman)) {
    ...
    if (mysqli_query($conn, $sqlUpdatePeminjaman)) {
        ...
        header("Location: admin/auditorium.php?status=success");
        exit();
    } else {
  ...
  <body>
    ...
    <div class="container">
      <div id="drop-area" class="row">
        <form id="upload-form" action="upload.php?id_peminjaman=<?php echo $idPeminjaman; ?>" method="post" enctype="multipart/form-data">
